...
5. Переходим в папку build. Открываем в этой папке терминал. И пишем: `make`
...
> [!NOTE]
> Если вы будете импортировать какую то библиотеку в свой файл .c, то указывайте к ней путь ввиде: `../drivers/screen.h`.
...
> [!NOTE]
> Цветовую схему можно использовать как 0x Цвет фона текста и Цвет текста. Например: В примере выше использовалась цветовая схема 0x04, тоесть чёрный фон текста и красный цвет текста, тоесть после 0x где 0 там чёрный цвет, а где 4 там красный. Снизу я напишу таблицу.
