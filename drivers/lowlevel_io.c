...
- Файл: ./drivers/lowlevel_io.c
- Значение файла: Этот файл отвечает за низко уровневые функции. А точнее - "Низкоуровневые I/O функции для работы с девайсами". Честно говоря, этот файл тоже взят с интернета.
- Создан в: Kali Linux
================================
*/
